...
<AppLayout>
    ...
    {#if selected}
        <div class="fixed inset-0 z-50">
            ...
            <aside class="fixed inset-x-0 bottom-0 z-50 flex max-h-[90vh] w-full flex-col rounded-t-3xl bg-white shadow-2xl transition-all duration-300 lg:inset-y-0 lg:right-0 lg:left-auto lg:h-full lg:max-h-none lg:w-full lg:max-w-[540px] lg:rounded-none">
                <!-- Mobile drag handle bar -->
                <div class="flex justify-center pt-3 pb-1 lg:hidden">
                    <div class="h-1.5 w-12 rounded-full bg-slate-200"></div>
                </div>
                <header class="flex items-start justify-between gap-3 border-b border-slate-100 px-4 sm:px-5 py-4">
                    <div>
